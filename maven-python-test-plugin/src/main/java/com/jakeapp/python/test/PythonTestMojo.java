package com.jakeapp.python.test;
...
public class PythonTestMojo extends AbstractMojo {
	 ...
	 * 
	 * @parameter expression="${jython-test.program}" default-value="nose"
	 */
	private String program;

	public void execute() throws MojoExecutionException {
		String oldUserDir = System.getProperty("user.dir");
		System.setProperty("user.dir", testOutputDirectory.getAbsolutePath());
		try {
			runTests();
		} finally {
